...
class Ui_MplMainWindow(object):
    def setupUi(self, MplMainWindow):
        ...
        self.mpl.setAutoFillBackground(False)
    ...
    def retranslateUi(self, MplMainWindow):
        ...
        self.mplactionOpen.setShortcut(_translate("MplMainWindow", "O"))
        self.mplactionQuit.setText(_translate("MplMainWindow", "Quit"))
        self.mplactionQuit.setShortcut(_translate("MplMainWindow", "Esc"))
